...
📝 otobüs → seems to violate the <CustomLink url="https://www.pickturkish.com/posts/a1/vowel-harmony" name="vowel harmony" /> (i.e **ü** and **o** not getting along just like 🌊 🚢.)
...
📝 The (da) is optional you can use <span className="text-yellow-600 dark:text-yellow-400 font-semibold">either</span> "**ya…ya**" <span className="text-yellow-600 dark:text-yellow-400 font-semibold">or</span> "**ya…ya da.**"  🙃
