...
❌ → `Onca` and `Onlarca` don’t express opinion but rather number. It is caused because the number 10 in Turkish is  "**on**". `Onca` and `onlarca` both mean `tens` as in the sentence “Tens of thousands of people come to this place everyday.”   
