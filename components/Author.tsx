...
const Author = () => {
  return (
    <div className="flex items-center justify-between h-16 md:h-24 px-2 py-1 rounded-xl border border-gray-300 bg-[#f1f5f8] dark:bg-[#262626]">
      <div className="flex items-center space-x-3">
        ...
        />
        <p className="font-semibold text-md md:text-lg text-gray-900 dark:text-white">Abbas Abdelila</p>
      </div>
